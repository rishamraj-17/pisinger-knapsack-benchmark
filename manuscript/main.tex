...
\midrule
Greedy & \texttt{log\_time\_millis} & 0.856 & 0.858 & $+0.001$ & 0.855 & $-5.07$\textsuperscript{$\dagger$} \\
Dynamic Programming & \texttt{log\_time\_millis} & 0.978 & 0.979 & $+0.001$ & 0.978 & $+0.810$\textsuperscript{$\ddagger$} \\
Dynamic Programming & \texttt{log\_memory\_mb} & 0.008 & 0.008 & $\approx 0$ & 0.003 & $-110.4$\textsuperscript{$\dagger$} \\
Branch \& Bound & \texttt{log\_time\_millis} & 0.743 & 0.961 & $+0.217$ & 0.331 & $-0.190$\textsuperscript{$\dagger$} \\
Branch \& Bound & \texttt{log\_nodes\_explored} & 0.735 & 0.979 & $+0.245$ & 0.978 & $-0.459$\textsuperscript{$\dagger$} \\
\bottomrule
\end{tabular}
...
\midrule
Greedy & \texttt{optimality\_gap} & 0.216 & 0.274 & $+0.058$ \\
Dynamic Programming & \texttt{fill\_rate} & 0.253 & 0.270 & $+0.017$ \\
\bottomrule
\end{tabular}
\end{table}
