...
- **File**: `out/results/full_experiment.csv` (canonical CSV, 2250 rows = 750 instances x 3 algorithms)
...
analyze.py (reads CSV, computes statistics, generates figures)
      |
      v
out/results/full_experiment.csv (2250 rows)
      |
      v
Main.java -> BenchmarkRunner -> Algorithms
      |
      v
DatasetGenerator (5 families x 5 sizes x 30 seeds = 750 instances)
```
