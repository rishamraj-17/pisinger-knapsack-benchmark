...
Reads the experimental CSV produced by BenchmarkRunner and generates:
  - LaTeX tables with 95% bootstrap confidence intervals (outputs/tables/*.tex)
  - Publication-quality figures in PDF, PNG, and SVG (outputs/figures/fixed/pdf/, outputs/figures/fixed/png/, outputs/figures/fixed/svg/, outputs/figures/scaled/pdf/, outputs/figures/scaled/png/, outputs/figures/scaled/svg/)
  - A CSV summary of all results (outputs/tables/table_full_summary.csv)
...
If no path is given, reads data/raw/full_experiment.csv.
"""
...
# --- Configuration ---
CSV_FILE = sys.argv[1] if len(sys.argv) > 1 else 'data/raw/full_experiment.csv'
