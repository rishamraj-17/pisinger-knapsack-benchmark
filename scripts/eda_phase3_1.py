...
Reads the canonical dataset (out/results/canonical_dataset.csv), performs
...
Outputs:
  ...
  eda_output/histograms/*.png        (one per numeric column)
  eda_output/boxplots/*.png          (one per outcome + key metric)
  eda_output/column_categories.txt
...
# ─── Paths ─────────────────────────────────────────────────────────────
CSV_PATH = 'out/results/canonical_dataset.csv'
OUT_DIR = 'eda_output'
