...
public final class StronglyCorrelatedGenerator implements InstanceGenerator {
    final int n;
    final int capacity;
    final int maxWeight;

    public StronglyCorrelatedGenerator(int n, int capacity, int maxWeight) {
        this.n = n;
