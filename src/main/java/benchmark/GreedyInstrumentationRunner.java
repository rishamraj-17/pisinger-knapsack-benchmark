...
public final class GreedyInstrumentationRunner {
    ...
    public static void main(String[] args) {
        ...
        try (FileWriter writer = new FileWriter(outputPath.toFile());
             CSVPrinter printer = new CSVPrinter(writer,
                 CSVFormat.DEFAULT.builder().setHeader(GreedyInstrumentation.csvHeader()).build())) {
            ...
            System.out.println("Running instrumented Greedy (fixed mode)...");
            for (KnapsackInstance inst : fixedInstances) {
                ...
                try {
                    ...
                    // Greedy threw (interrupt, etc.) — stats populated up to failure point
                } catch (Exception e) {
            ...
            System.out.println("Running instrumented Greedy (scaled mode)...");
